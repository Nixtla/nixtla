...
- Get your API key from [dashboard.nixtla.io](https://nixtla.io/free-trial?utm_source=nixtla.io&utm_campaign=/forecasting/timegpt_2_family). Note that you can also use your existing keys as long as your account has access to these latest models (Step 1 above).
