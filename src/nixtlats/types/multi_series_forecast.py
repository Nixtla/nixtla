...
class MultiSeriesForecast(pydantic_v1.BaseModel):
    ...
    fewshot_loss: typing.Optional[MultiSeriesForecastFewshotLoss] = pydantic_v1.Field()
    """
    ...
    finetune_loss: typing.Optional[MultiSeriesForecastFinetuneLoss] = pydantic_v1.Field()
    """
