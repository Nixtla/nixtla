...
def test_forecast(nixtla_test_client, spark_df, spark_diff_cols_df, distributed_n_series):
    check_forecast_dataframe(nixtla_test_client, spark_df, n_series_to_check=distributed_n_series)
