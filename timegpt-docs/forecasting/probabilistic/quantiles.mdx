...
## When You Need Complete Future Paths

Quantiles describe uncertainty separately at each forecast timestamp. If your
decision depends on the sequence or cumulative total across the horizon, use
[forecast simulation](/forecasting/probabilistic/simulation) to generate
