...
![](/nixtla/docs/tutorials/11_loss_function_finetuning_files/figure-markdown_strict/cell-7-output-1.png)
...
by 9.27% when compared to using the default loss function.
