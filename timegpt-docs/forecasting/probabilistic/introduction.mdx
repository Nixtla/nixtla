...
description: "Learn how to generate quantile forecasts, prediction intervals, and simulated sample paths to capture uncertainty in your forecasts."
...
**TimeGPT** supports uncertainty quantification through quantile forecasts, prediction intervals, and forecast simulation. Quantiles and intervals describe the uncertainty at each future timestamp; simulation goes one step further and generates complete future paths, so you can answer questions about outcomes that span the whole horizon, such as total cost or the chance of ever crossing a threshold.
...
<CardGroup>
  ...
  <Card title="Forecast Simulation" href="/forecasting/probabilistic/simulation">
    Generate complete future paths for probability, risk, and scenario analysis.
  </Card>
</CardGroup>
