...
class SingleSeriesForecast(pydantic_v1.BaseModel):
    ...
    fewshot_loss: typing.Optional[SingleSeriesForecastFewshotLoss] = pydantic_v1.Field()
    """
    ...
    x: typing.Optional[typing.Dict[str, typing.List[float]]] = pydantic_v1.Field()
    """
    ...
    finetune_loss: typing.Optional[SingleSeriesForecastFinetuneLoss] = pydantic_v1.Field()
    """
