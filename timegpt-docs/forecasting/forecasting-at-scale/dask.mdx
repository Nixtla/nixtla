---
title: "Time Series Forecasting with Dask and TimeGPT"
...
Dask is an open-source parallel computing library for Python that scales pandas workflows seamlessly. This guide explains how to use TimeGPT from Nixtla with Dask for distributed forecasting tasks.
