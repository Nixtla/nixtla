...
<CardGroup>
  <Card title="Quantile Forecasts" cta="Learn more" href="/forecasting/probabilistic/quantiles">
    Learn how to compute quantile forecasts using **TimeGPT**. 
  </Card>
  <Card title="Prediction Intervals" cta="Learn more" href="/forecasting/probabilistic/prediction_intervals">
