  ...
  'syms': { 'nixtla.date_features': { 'nixtla.date_features.CountryHolidays': ( 'src/date_features.html#countryholidays',
            ...
            'nixtla.nixtla_client': { 'nixtla.nixtla_client.ApiError': ('src/nixtla_client.html#apierror', 'nixtla/nixtla_client.py'),
                                      ...
                                      'nixtla.nixtla_client._maybe_add_date_features': ( 'src/nixtla_client.html#_maybe_add_date_features',
                                                                                         'nixtla/nixtla_client.py'),
                                      'nixtla.nixtla_client._maybe_add_id': ( 'src/nixtla_client.html#_maybe_add_id',
                                                                              'nixtla/nixtla_client.py'),
                                      ...
                                      'nixtla.nixtla_client._maybe_infer_freq': ( 'src/nixtla_client.html#_maybe_infer_freq',
                                                                                  'nixtla/nixtla_client.py'),
                                      'nixtla.nixtla_client._maybe_set_time_from_index': ( 'src/nixtla_client.html#_maybe_set_time_from_index',
                                                                                           'nixtla/nixtla_client.py'),
