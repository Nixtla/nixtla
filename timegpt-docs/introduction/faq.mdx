...
<Tabs>
  <Tab title="TimeGPT" icon="chart-line">
    ...
    <Accordion title="How do I get started with TimeGPT?">
      To get started with TimeGPT, register for an account at [dashboard](https://www.nixtla.io/book-a-free-trial?utm_source=nixtla.io&utm_campaign=/docs/introduction/faq). After confirming your signup via email, you can access your dashboard with account details.

      <Steps>
        <Step title="Sign up" icon="plus">
          Create an account at [dashboard](https://www.nixtla.io/book-a-free-trial?utm_source=nixtla.io&utm_campaign=/docs/introduction/faq)
        </Step>
  ...
  <Tab title="API Key" icon="key">
    ...
    <Accordion title="Where can I get an API key?">
      Upon registration, you receive an API key available in your [dashboard](https://www.nixtla.io/book-a-free-trial?utm_source=nixtla.io&utm_campaign=/docs/introduction/faq) under "API Keys". Keep your API key confidential.
    </Accordion>
  ...
  <Tab title="Troubleshooting" icon="wrench">
    ...
    <Accordion title="Error message: Invalid API key">
      ...
      <Note>
        This error occurs when your TimeGPT API key is invalid or not set up correctly. Use the `validate_api_key` method to verify it or check that you copied it correctly from the "API Keys" section of your [dashboard](https://www.nixtla.io/book-a-free-trial?utm_source=nixtla.io&utm_campaign=/docs/introduction/faq).
      </Note>
    </Accordion>
    ...
    <Accordion title="Error message: Too many requests">
      ...
      <Note>
        This error occurs when you have exhausted your free credits and need to add a payment method to continue using TimeGPT. Add a payment method in the "Billing" section of your [dashboard](https://www.nixtla.io/book-a-free-trial?utm_source=nixtla.io&utm_campaign=/docs/introduction/faq).
      </Note>
    </Accordion>
