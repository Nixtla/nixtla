...
1. **Get an API Key** from the [Nixtla Dashboard](https://nixtla.io/free-trial?utm_source=nixtla.io&utm_campaign=/experiments/vn1-competition). Copy it and paste it into the `.env.example` file. Rename the file to `.env`.
