...
title: Anomaly detection with date features
---
...
![](/nixtla/docs/2_capabilities/anomaly_detection/03_anomaly_detection_date_features_files/figure-markdown_strict/cell-7-output-1.png)
