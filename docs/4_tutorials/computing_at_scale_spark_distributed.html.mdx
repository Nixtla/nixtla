...
title: Computing at Scale with Spark
---
...
Data](#load-your-data) 3. [Initialize Spark](#initialize-spark) 4. [Use
TimeGPT on Spark](#use-timegpt-on-spark) 5. [Stop Spark](#stop-spark)
