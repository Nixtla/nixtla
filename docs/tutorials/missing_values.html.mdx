...
**Outline** 1. [Load Data](#load-data)

1.  [Get Started with TimeGPT](#get-started-with-timegpt)

2.  [Visualize Data](#visualize-data)

3.  [Fill Missing Values](#fill-missing-values)
...
![](/nixtla/docs/tutorials/15_missing_values_files/figure-markdown_strict/cell-8-output-1.png)
...
![](/nixtla/docs/tutorials/15_missing_values_files/figure-markdown_strict/cell-9-output-1.png)
...
![](/nixtla/docs/tutorials/15_missing_values_files/figure-markdown_strict/cell-13-output-1.png)
