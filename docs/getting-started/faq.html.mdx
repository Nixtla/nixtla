...
-   Consider any firewalls your organization might have. There may be
    restricted access. If so, you can whitelist our endpoints.  
...
`TimeGPT` has a flat fee pricing structure with subscription. We
currently have an Early Adopter subscription plan special rate, with a
30 day free trial. You can cancel anytime.

-   \$99/month for up to 10,000 API calls per month
-   \$300/month to add Premium Support. A dedicated Slack/Teams channel
    is available for priority support, best practices guidance, and
    feature prioritization. Sign up to receive expert advice and
    dedicated treatment from our team of experts.

[Start your Free Trial](https://dashboard.nixtla.io/freetrial)

For pricing of TimeGEN-1 on Azure, see the section on how tokens are
counted.

Are there free credits or discounts?

Access is through our flat fee subscription plan. We do provide some
credits for academic research. If you would like to learn more, please
email us at ops@nixtla.io.
