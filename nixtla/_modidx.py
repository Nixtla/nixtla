  ...
  'syms': { 'nixtla.date_features': { 'nixtla.date_features.CountryHolidays': ( 'src/date_features.html#countryholidays',
            ...
            'nixtla.nixtla_client': { 'nixtla.nixtla_client.ApiError': ('src/nixtla_client.html#apierror', 'nixtla/nixtla_client.py'),
                                      ...
                                      'nixtla.nixtla_client.NixtlaClient._distributed_detect_anomalies': ( 'src/nixtla_client.html#nixtlaclient._distributed_detect_anomalies',
                                                                                                           'nixtla/nixtla_client.py'),
                                      'nixtla.nixtla_client.NixtlaClient._distributed_detect_anomalies_realtime': ( 'src/nixtla_client.html#nixtlaclient._distributed_detect_anomalies_realtime',
                                                                                                                    'nixtla/nixtla_client.py'),
                                      ...
                                      'nixtla.nixtla_client.NixtlaClient.detect_anomalies': ( 'src/nixtla_client.html#nixtlaclient.detect_anomalies',
                                                                                              'nixtla/nixtla_client.py'),
                                      'nixtla.nixtla_client.NixtlaClient.detect_anomalies_realtime': ( 'src/nixtla_client.html#nixtlaclient.detect_anomalies_realtime',
                                                                                                       'nixtla/nixtla_client.py'),
                                      ...
                                      'nixtla.nixtla_client._cross_validation_wrapper': ( 'src/nixtla_client.html#_cross_validation_wrapper',
                                                                                          'nixtla/nixtla_client.py'),
                                      'nixtla.nixtla_client._detect_anomalies_realtime_wrapper': ( 'src/nixtla_client.html#_detect_anomalies_realtime_wrapper',
                                                                                                   'nixtla/nixtla_client.py'),
