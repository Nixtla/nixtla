...
<Steps>
  <Step title="Option 1: Copy & Paste into Python">
    ...
    **Step 1:** Copy your key from the [Nixtla Dashboard](https://www.nixtla.io/book-a-free-trial?utm_source=nixtla.io&utm_campaign=/docs/setup/setting_up_your_api_key).
...
<Info>
  You do not need to validate your API key before every request. This method is a convenience function. To fully access **TimeGPT** functionality, ensure you have adequate credits by checking your [Nixtla Dashboard](https://www.nixtla.io/book-a-free-trial?utm_source=nixtla.io&utm_campaign=/docs/setup/setting_up_your_api_key).
</Info>
