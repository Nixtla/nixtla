...
Head to the [TimeGPT excel add-in page in Microsoft
...
the [Nixtla Dashboard](https://www.nixtla.io/book-a-free-trial?utm_source=nixtla.io&utm_campaign=/docs/reference/timegpt_excel_add_in_beta_).
...
Dashboard](https://www.nixtla.io/book-a-free-trial?utm_source=nixtla.io&utm_campaign=/docs/reference/timegpt_excel_add_in_beta_). Paste it into the box that say
