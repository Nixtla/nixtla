...
* HTTPS: `git clone https://github.com/Nixtla/autotimeseries.git`
* SSH: `git clone git@github.com:Nixtla/autotimeseries.git`
* GitHub CLI: `gh repo clone Nixtla/autotimeseries`
