...
<figure>
<a
href="https://colab.research.google.com/github/Nixtla/nixtla/blob/main/nbs/docs/tutorials/05_multiple_series.ipynb"><img
...
[`NixtlaClient`](https://nixtlaverse.nixtla.io/nixtla/nixtla_client.html#nixtlaclient):

```python
nixtla_client.plot(df)
```

![](05_multiple_series_files/figure-markdown_strict/cell-11-output-1.png)
...
![](05_multiple_series_files/figure-markdown_strict/cell-13-output-1.png)
...
![](05_multiple_series_files/figure-markdown_strict/cell-15-output-1.png)
