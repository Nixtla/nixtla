...
## <kbd>function</kbd> `validate_no_nested_dict`

```python
validate_no_nested_dict(
...
forecast(
    ...
    model_parameters: Annotated[Optional[Dict[str, Any]], AfterValidator(func=<function validate_no_nested_dict at 0x7f6246e9ae60>)] = None
) → ~AnyDFType
```
