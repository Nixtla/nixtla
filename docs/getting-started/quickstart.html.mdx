---
description: "TimeGPT is a production ready, generative pretrained transformer for time series. It's capable of accurately predicting various domains such as retail, electricity, finance, and IoT with just a few lines of code \U0001F680."
...
-   Go to
    [dashboard.nixtla.io/freetrial](https://dashboard.nixtla.io/freetrial)
    to activate your free trial and set up an account.
