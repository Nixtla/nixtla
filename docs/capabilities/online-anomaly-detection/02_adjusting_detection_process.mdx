...
<figure>
<a
href="https://colab.research.google.com/github/Nixtla/nixtla/blob/main/nbs/docs/capabilities/online-anomaly-detection/02_adjusting_detection_process.ipynb"><img
...
After initializing an instance of `NixtlaClient`, let’s explore an
example using the Peyton Manning dataset.
...
![](02_adjusting_detection_process_files/figure-markdown_strict/cell-13-output-1.png)
...
![](02_adjusting_detection_process_files/figure-markdown_strict/cell-15-output-1.png)
...
![](02_adjusting_detection_process_files/figure-markdown_strict/cell-17-output-1.png)
