...
class TestTimeSeriesDataSet1():
    def test_finetuning_and_forecasting(self, custom_client, ts_data_set1):
        # Finetune the model
        finetune_resp = custom_client.finetune(ts_data_set1.train, output_model_id=model_ids_object.model_id1)
        assert finetune_resp == model_ids_object.model_id1

        model_id2 = custom_client.finetune(ts_data_set1.train, finetuned_model_id=model_ids_object.model_id1)
        ...
        forecast1 = custom_client.forecast(ts_data_set1.train, h=ts_data_set1.h, finetuned_model_id=model_ids_object.model_id1)
        forecast2 = custom_client.forecast(ts_data_set1.train, h=ts_data_set1.h, finetuned_model_id=model_ids_object.model_id2)
    ...
    def test_cv_with_finetuned_model(self, custom_client, ts_data_set1):
        ...
        cv_finetune = custom_client.cross_validation(ts_data_set1.series, n_windows=2, h=ts_data_set1.h, finetuned_model_id=model_ids_object.model_id1)
    ...
    def test_anomaly_detection_with_finetuned_model(self, custom_client, ts_anomaly_data):
        ...
        anomaly_finetune = custom_client.detect_anomalies(ts_anomaly_data.train_anomalies, finetuned_model_id=model_ids_object.model_id2)
    ...
    def test_list_finetuned_models(self, custom_client):
        ...
        assert model_ids_object.model_id1 not in ids and model_ids_object.model_id2 in ids
