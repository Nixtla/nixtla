...
title: Adjust confidence levels for anomaly detection
---
...
![](/nixtla/docs/2_capabilities/anomaly_detection/02_confidence_levels_files/figure-markdown_strict/cell-7-output-1.png)
