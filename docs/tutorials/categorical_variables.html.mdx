...
possible values, and induce a grouping of your observations.[^1]
...
(`unique_id` column) at every timestamp (`ds` column). - `X_df`,
containing additional relevant information for each unique product
...
![](/nixtla/docs/tutorials/13_categorical_variables_files/figure-markdown_strict/cell-13-output-1.png)
...
![](/nixtla/docs/tutorials/13_categorical_variables_files/figure-markdown_strict/cell-15-output-1.png)
