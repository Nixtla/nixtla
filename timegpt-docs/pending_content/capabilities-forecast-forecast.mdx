  ...
  <Tab title="Fine-Tuning & Advanced Topics">
    <AccordionGroup>
      ...
      <Accordion title="Irregular Timestamps">
        ...
        [Handling irregular timestamps](https://docs.nixtla.io/docs/capabilities-forecast-irregular_timestamps).
      </Accordion>
    </AccordionGroup>
  </Tab>
</Tabs>
...
<Frame caption="Visual depiction of a sample zero-shot forecast with TimeGPT">
  ![Forecast Example](images/docs/Nixtla/nixtla/readme_docs/nbs/_docs/docs/getting-started/2_quickstart_files/figure-markdown_strict/cell-17-output-1.png)
</Frame>
