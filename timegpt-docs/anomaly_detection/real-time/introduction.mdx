...
- **Flexible Control**: Gain more flexibility and control over the anomaly detection process
- **Local & Global**: Perform local and global anomaly detection
- **Stream Processing**: Detect anomalies on stream data as it arrives
